document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch(`https://8000-axelcarrill-herokubacke-l038cx8hr2i.ws-us106.gitpod.io/contactos/${encodeURIComponent(email)}`, {
        headers: {
...
function checkTokenAndRedirect() {
    ...
    request.open('GET', 'https://8000-axelcarrill-herokubacke-l038cx8hr2i.ws-us106.gitpod.io/check_token');
