document.addEventListener("DOMContentLoaded", function () {
    ...
    fetch(`https://8000-gustavodelrazo-authback-8deexani14p.ws-us106.gitpod.io/contactos/${encodeURIComponent(email)}`, {
        headers: {
...
function checkTokenAndRedirect() {
    ...
    request.open('GET', 'https://8000-gustavodelrazo-authback-8deexani14p.ws-us106.gitpod.io/check_token');
